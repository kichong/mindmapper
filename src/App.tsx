...
import { DEFAULT_NODE_COLORS } from './constants/palette'
...
export default function App() {
  ...
  const handleAddChild = useCallback(() => {
    ...
    const paletteIndex = nodes.length % DEFAULT_NODE_COLORS.length
    const nodeColor = DEFAULT_NODE_COLORS[paletteIndex]
  ...
  return (
    <div className="app-shell">
      ...
      <NodeInspector palette={DEFAULT_NODE_COLORS} />
    </div>
  )
}
